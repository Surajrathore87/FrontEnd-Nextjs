...
const GroupedDesign = dynamic(import("components/GroupedDesign"));
const MetaData = dynamic(import("components/Common/MetaData"));
export default function groupedDesign(props) {
  ...
  return (
    <>
      ...
      <GroupedDesign designCode={product?.[0]} designDetailsData={designDetailsData} />
    </>
  );
}
